/**
 * BEACON Intelligence Layer — beacon-intel
 *
...
const WIKIDATA_UA = 'BEACON-Intel/1.0 (https://beacon.live; ontology engine)';
...
app.get('/resolve', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      links: result.links,
      entity: { type, id },
      source: 'BEACON Intelligence Layer',
...
async function boot() {
  console.log('[INTEL] BEACON Intelligence Layer starting...');
  await loadSanctions();
