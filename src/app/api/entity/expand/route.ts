...
/**
 * Thin proxy to the BEACON Intelligence Layer (beacon-intel).
 *
 * In Docker: fetches from http://beacon-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[BEACON] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(
